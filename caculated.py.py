...
textDisplay = Entry(cal,font=('arial',20,'bold'), textvariable=text_Input, bd=30, insertwidth=10,
...
btnEquala=Button(cal,padx=16,pady=16,bd=8, fg="black",font=('arial',20,'bold'),
